...
private val outputFile = File("C:\\Users\\stewue\\OneDrive - Wuersten\\Uni\\19_HS\\Masterarbeit\\Repo\\Evaluation\\RQ2_Results\\variability\\forkcorrelation.csv")
...
fun main() {
    ...
    output.appendln("project;benchmark;params;changeRateCov;forksCov;changeRateCi;forksCi;changeRateDivergence;forksDivergence")
    ...
    file.walk().forEach {
        if (it.parent == file.absolutePath && it.isDirectory) {
            ...
            variability.forEachLine {
                ...
                output.appendln("$project;$benchmark;$params;${meanChangeRate(meanDefault, meanCov)};${forkCov[key]};${meanChangeRate(meanDefault, meanCi)};${forkCi[key]};${meanChangeRate(meanDefault, meanKld)};${forkDivergence[key]}")
            }
        }
    }
