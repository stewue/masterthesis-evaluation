package ch.uzh.ifi.seal.smr.soa.result.projects
...
/*
private val jmhDate = mapOf(
        JMHVersion(1, 21) to "May, 2018",
        JMHVersion(1, 20) to "Jan, 2018",
        JMHVersion(1, 19) to "May, 2017",
        JMHVersion(1, 18) to "Mar, 2017",
        JMHVersion(1, 17, 5) to "Feb, 2017",
        JMHVersion(1, 17, 4) to "Jan, 2017",
        JMHVersion(1, 17, 3) to "Dec, 2016",
        JMHVersion(1, 17, 2) to "Dec, 2016",
        JMHVersion(1, 17, 1) to "Nov, 2016",
        JMHVersion(1, 17) to "Nov, 2016",
        JMHVersion(1, 16) to "Nov, 2016",
        JMHVersion(1, 15) to "Sep, 2016",
        JMHVersion(1, 14, 1) to "Sep, 2016",
        JMHVersion(1, 14) to "Sep, 2016",
        JMHVersion(1, 13) to "Jul, 2016",
        JMHVersion(1, 12) to "Apr, 2016",
        JMHVersion(1, 11, 3) to "Jan, 2016",
        JMHVersion(1, 11, 2) to "Oct, 2015",
        JMHVersion(1, 11, 1) to "Sep, 2015",
        JMHVersion(1, 11) to "Sep, 2015",
        JMHVersion(1, 10, 5) to "Aug, 2015",
        JMHVersion(1, 10, 4) to "Aug, 2015",
        JMHVersion(1, 10, 3) to "Jul, 2015",
        JMHVersion(1, 10, 2) to "Jul, 2015",
        JMHVersion(1, 10, 1) to "Jun, 2015",
        JMHVersion(1, 10) to "Jun, 2015",
        JMHVersion(1, 9, 3) to "May, 2015",
        JMHVersion(1, 9, 2) to "May, 2015",
        JMHVersion(1, 9, 1) to "Apr, 2015",
        JMHVersion(1, 9) to "Apr, 2015",
        JMHVersion(1, 8) to "Apr, 2015",
        JMHVersion(1, 7, 1) to "Apr, 2015",
        JMHVersion(1, 7) to "Mar, 2015",
        JMHVersion(1, 6, 3) to "Mar, 2015",
        JMHVersion(1, 6, 2) to "Mar, 2015",
        JMHVersion(1, 6, 1) to "Feb, 2015",
        JMHVersion(1, 6) to "Feb, 2015",
        JMHVersion(1, 5, 2) to "Feb, 2015",
        JMHVersion(1, 5, 1) to "Jan, 2015",
        JMHVersion(1, 5) to "Jan, 2015",
        JMHVersion(1, 4, 2) to "Jan, 2015",
        JMHVersion(1, 4, 1) to "Dec, 2014",
        JMHVersion(1, 4) to "Dec, 2014",
        JMHVersion(1, 3, 4) to "Dec, 2014",
        JMHVersion(1, 3, 3) to "Dec, 2014",
        JMHVersion(1, 3, 2) to "Nov, 2014",
        JMHVersion(1, 3, 1) to "Nov, 2014",
        JMHVersion(1, 3) to "Nov, 2014",
        JMHVersion(1, 2) to "Nov, 2014",
        JMHVersion(1, 1, 1) to "Sep, 2014",
        JMHVersion(1, 1) to "Sep, 2014",
        JMHVersion(1, 0, 1) to "Sep, 2014",
        JMHVersion(1, 0) to "Aug, 2014",
        JMHVersion(0, 9, 8) to "Aug, 2014",
        JMHVersion(0, 9, 7) to "Aug, 2014",
        JMHVersion(0, 9, 6) to "Aug, 2014",
        JMHVersion(0, 9, 5) to "Jul, 2014",
        JMHVersion(0, 9, 4) to "Jul, 2014",
        JMHVersion(0, 9, 3) to "Jul, 2014",
        JMHVersion(0, 9, 2) to "Jul, 2014",
        JMHVersion(0, 9, 1) to "Jun, 2014",
        JMHVersion(0, 9) to "Jun, 2014",
        JMHVersion(0, 8) to "May, 2014",
        JMHVersion(0, 7, 3) to "May, 2014",
        JMHVersion(0, 7, 2) to "May, 2014",
        JMHVersion(0, 7, 1) to "May, 2014",
        JMHVersion(0, 7) to "May, 2014",
        JMHVersion(0, 6) to "Apr, 2014",
        JMHVersion(0, 5, 7) to "Apr, 2014",
        JMHVersion(0, 5, 6) to "Apr, 2014",
        JMHVersion(0, 5, 5) to "Mar, 2014",
        JMHVersion(0, 5, 4) to "Mar, 2014",
        JMHVersion(0, 5, 3) to "Mar, 2014",
        JMHVersion(0, 5, 2) to "Mar, 2014",
        JMHVersion(0, 5) to "Mar, 2014",
        JMHVersion(0, 4, 2) to "Feb, 2014",
        JMHVersion(0, 4, 1) to "Feb, 2014",
        JMHVersion(0, 4) to "Feb, 2014",
        JMHVersion(0, 3, 2) to "Feb, 2014",
        JMHVersion(0, 3, 1) to "Jan, 2014",
        JMHVersion(0, 3) to "Jan, 2014",
        JMHVersion(0, 2, 1) to "Jan, 2014",
        JMHVersion(0, 2) to "Dec, 2013",
        JMHVersion(0, 1) to "Nov, 2013"
)
 */