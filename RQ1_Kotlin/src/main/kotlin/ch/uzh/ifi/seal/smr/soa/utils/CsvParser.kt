...
import ch.uzh.ifi.seal.smr.soa.analysis.samplecommits.SampleCommit
...
class CsvCommitParser(file: File) : CsvParser<SampleCommit>(file, SampleCommit::class.java, true)
